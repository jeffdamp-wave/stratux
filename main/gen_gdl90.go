...
const (
	...
	*/
	...
	STRATUX_OWNER_RATE   = 50 * time.Millisecond // 20hz  DEFAULT_MSG_RATE
	STRATUS_OWNER_RATE   = 50 * time.Millisecond // 20hz 
	STRATUX_TRAFFIC_RATE = 900 * time.Millisecond // DEFAULT_MSG_RATE
